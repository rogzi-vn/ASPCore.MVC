...
namespace ASPCoreMVC.Web.Pages.Account
{
    ...
    public class ProfileModel : AppPageModel
    {
        ...
        [BindProperty] public AppUserProfileDTO UserProfile { get; set; }
        [BindProperty] public _UploadUserPhotoDTO UserAvatar { get; set; }
        [BindProperty] public AppUserPasswordDTO AppUserPassword { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (isUpdatePasswordSignal)
            {
                ...
                if (AppUserPassword.CurrentPassword.IsNullOrEmpty())
                    ModelState.AddModelError("AppUserPassword.CurrentPassword",
                        L["Please input your current password"]);
                ...
                if (AppUserPassword.ConfirmNewPassword.IsNullOrEmpty())
                    ModelState.AddModelError("AppUserPassword.ConfirmNewPassword",
                        L["Please input confirm of your new password"]);
            }
            ...
            if (isUpdatePasswordSignal)
            {
                ...
                if (CurrentUser.Id != null)
                {
                    ...
                    if (!await _IdentityUserManager.CheckPasswordAsync(currentIdentityUser,
                            AppUserPassword.CurrentPassword))
                    ...
                    else
                    {
                        ...
                        var result = await _IdentityUserManager.ChangePasswordAsync(currentIdentityUser,
                            AppUserPassword.CurrentPassword, AppUserPassword.NewPassword);
                        if (result.Succeeded)
