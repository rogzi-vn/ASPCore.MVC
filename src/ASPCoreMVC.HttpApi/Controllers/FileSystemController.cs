...
namespace ASPCoreMVC.Controllers
{
    ...
    public class FileSystemController : AppController
    {
        ...
        {
            string pathroot = Path.Combine(CurrentTenant.Name ?? "host", "user_files");
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                MaxUploadSizeInMb = AppContractConsts.MaxFileSizeInMB, // Limit imposed to user uploaded file <= 2048 KB
