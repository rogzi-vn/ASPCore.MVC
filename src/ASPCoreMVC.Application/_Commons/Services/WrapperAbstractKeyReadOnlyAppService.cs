...
{
    public abstract class WrapperAbstractKeyReadOnlyAppService<TEntity, TEntityDto, TKey>
        : WrapperAbstractKeyReadOnlyAppService<TEntity, TEntityDto, TEntityDto, TKey, PagedAndSortedResultRequestDto>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyReadOnlyAppService(IReadOnlyRepository<TEntity> repository)
            : base(repository)
        {
    ...
    public abstract class WrapperAbstractKeyReadOnlyAppService<TEntity, TEntityDto, TKey, TGetListInput>
        : WrapperAbstractKeyReadOnlyAppService<TEntity, TEntityDto, TEntityDto, TKey, TGetListInput>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyReadOnlyAppService(IReadOnlyRepository<TEntity> repository)
            : base(repository)
    ...
    public abstract class WrapperAbstractKeyReadOnlyAppService<TEntity, TGetOutputDto, TGetListOutputDto, TKey, TGetListInput>
        : ApplicationService
        ...
        where TEntity : class, IEntity
    {
        ...
        public virtual async Task<ResponseWrapper<TGetOutputDto>> GetAsync(TKey id)
        {
            ...
            if (entity != null)
                return new ResponseWrapper<TGetOutputDto>(
                    ...
                    "Successful");
            return new ResponseWrapper<TGetOutputDto>(default, "Not found", 404);
        }

        public virtual async Task<ResponseWrapper<PagedResultDto<TGetListOutputDto>>> GetListAsync(TGetListInput input)
        {
            ...
            return new ResponseWrapper<PagedResultDto<TGetListOutputDto>>(
                   new PagedResultDto<TGetListOutputDto>(
                    totalCount,
                    entityDtos),
                   "Successful");
        }
        ...
        protected virtual IQueryable<TEntity> ApplyDefaultSorting(IQueryable<TEntity> query)
        {
            ...
            throw new AbpException("No sorting specified but this query requires sorting. Override the ApplyDefaultSorting method for your application service derived from WrapperAbstractKeyReadOnlyAppService!");
        }
