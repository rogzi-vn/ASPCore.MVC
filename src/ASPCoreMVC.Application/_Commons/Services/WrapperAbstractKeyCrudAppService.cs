...
{
    public abstract class WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey>
        : WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, PagedAndSortedResultRequestDto>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyCrudAppService(IRepository<TEntity> repository)
            : base(repository)
        {
    ...
    public abstract class WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, TGetListInput>
        : WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TEntityDto, TEntityDto>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyCrudAppService(IRepository<TEntity> repository)
            : base(repository)
    ...
    public abstract class WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput>
        : WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TCreateInput>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyCrudAppService(IRepository<TEntity> repository)
            : base(repository)
    ...
    public abstract class WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
        : WrapperAbstractKeyCrudAppService<TEntity, TEntityDto, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
        where TEntity : class, IEntity
    {
        protected WrapperAbstractKeyCrudAppService(IRepository<TEntity> repository)
            : base(repository)
    ...
    public abstract class WrapperAbstractKeyCrudAppService<TEntity, TGetOutputDto, TGetListOutputDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
        : WrapperAbstractKeyReadOnlyAppService<TEntity, TGetOutputDto, TGetListOutputDto, TKey, TGetListInput>,
            IWrapperCrudAppService<TGetOutputDto, TGetListOutputDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
        where TEntity : class, IEntity
    {
        ...
        public virtual async Task<ResponseWrapper<TGetOutputDto>> CreateAsync(TCreateInput input)
        {
            ...
            return new ResponseWrapper<TGetOutputDto>(
                await MapToGetOutputDtoAsync(entity),
                "Create successful");
        }

        public virtual async Task<ResponseWrapper<TGetOutputDto>> UpdateAsync(TKey id, TUpdateInput input)
        {
