...
namespace ASPCoreMVC.Users
{
     ...
     */
    public class AppUser : AuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ASPCoreMVCDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ASPCoreMVCEfCoreEntityExtensionMappings to extend the IdentityUser entity
